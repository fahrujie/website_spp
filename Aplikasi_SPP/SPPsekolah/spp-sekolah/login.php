...
<body>
	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="panel-heading">
			<h2 style="text-align:center;">MENU LOGIN</h2>
			<?php if (isset($error) ) :  ?>
				<div class="alert alert-warning">
		<span><b><font color="red">Peringatan!!</b>Form Belum Lengkap</font></span>
		</div>
	<?php endif;  ?>
	...
	<form action="" method="post">
		<table class="table">
			...
			<tr>
				...
				<td></td>
				<td>
					<input type="submit" name="submit_Fahruji" formmethod="post" value="LOGIN">
					<input type="reset" name="reset_Fahruji" formaction="login.php" value="BATAL">
				</td>
			</tr>
		</table>
	</form>
