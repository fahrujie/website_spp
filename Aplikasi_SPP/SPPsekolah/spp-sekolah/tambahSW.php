...
<h2>TAMBAH DATA SISWA </h2>
 	...
 	<table class="table">
 		...
 		<tr>
 			<td>Tahun Ajaran</td>
 			<td>
 				<input class="form-control" type="text" name="tahunajaran" placeholder="Masukan Tahun Ajaran" maxlength="40" size="30" required>
 			</td>
 		</tr>
 		<tr>
 			<td>Biaya</td>
 			<td>
 				<input class="form-control" type="text" name="biaya" placeholder="Masukan Biaya" maxlength="40" size="30" required >
 			</td>
 		</tr>
 		<tr>
 			<td>Jatuh Tempo</td>
 			<td>
 				<input class="form-control" type="text" name="jatuhtempo" placeholder="Masukan Tanggal" maxlength="40" size="30" required >
 			</td>
 		</tr>
 		<tr>
 			<td></td>
